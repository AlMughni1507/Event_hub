    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-black">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        {article.featured_image && (
          <div className="mb-8">
            <img
              src={article.featured_image.startsWith('http') ? article.featured_image : `${getServerBaseUrl()}${article.featured_image}`}
              alt={article.title}
                ...
                >
                  <div className="aspect-video bg-gradient-to-r from-cosmic-navy to-stellar-blue relative overflow-hidden">
                    {relatedArticle.featured_image ? (
                      <img 
                        src={relatedArticle.featured_image.startsWith('http') ? relatedArticle.featured_image : `${getServerBaseUrl()}${relatedArticle.featured_image}`}
